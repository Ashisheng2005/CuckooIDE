...
# @Time : 2025/2/22 下午1:40 
# @Author : Huzhaojun
# @Version：V 1.0
# @File : NotBookFrame.py
# @desc : README.md
...
__all__ = ["Frame",  "Notebook", "Style", "Treeview",
           # Extensions
           # functions
...
if __name__ == '__main__':
    root = tkinter.Tk()
    notbook = Notebook(root)
    frame1 = tkinter.Frame(root)
    tkinter.Button(frame1, text="12312").pack()
    notbook.add(frame1, text='123')
    frame2 = tkinter.Frame(root)
    tkinter.Button(frame2, text="21312").pack()
    notbook.add(frame2, text='222')
